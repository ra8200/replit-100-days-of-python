print("I got a few quesitons for you about stupid shit.")
print()
print("Just Answer the questions so the code is right")
print()
myName = input("Whats your name?: ")
print("What a dewby name. Sorry I shouldn't have said that. anyway next qustion")
print()
...
if myPower == "Flight" or "flight":
  ...
  print("OOO big strong man, or woman, coming")
else: 
